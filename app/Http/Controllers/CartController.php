...
class CartController extends Controller
{
    ...
    //API to display books in cart

    public function displayBooksInCart(Request $request)
    {
        $book = Cart::all(); 
        if($book)
        {
...
//API to update only quantity in cart
